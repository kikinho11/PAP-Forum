<?php
    ...
    define('TITLE',"Forum | Cyber Forums");
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        ?>
            ...
            <a href="categories.php" class="btn btn-dark">All Categories</a>
        </small>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="posts.php?topic='.$row['topic_id'].'">
                        <div class="media text-muted pt-3">
                            ...
                            <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                              <strong class="d-block text-dark">'.ucwords($row['topic_subject']).'</strong></a>
                              <span class="text-grey">'.ucwords($row['uidUsers']).'</span><br>
                              '.date("jS F, Y", strtotime($row['topic_date'])).'
                            </p>
        ...
        <small class="d-block text-right mt-3">
            <a href="create-topic.php" class="btn btn-dark">Create A Forum</a>
            <a href="topics.php" class="btn btn-dark">All Forums</a>
        </small>
