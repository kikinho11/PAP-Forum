<?php
    ...
    define('TITLE',"Find People | Cytus Forums");
...
?>  
    ...
    <body style="background: #f1f1f1">
        ...
        <main role="main" class="container">
            <div class="mx-5">
                <div class="d-flex align-items-center p-3 my-3 mx-5 text-white-50 bg-dark rounded shadow-sm">
                    <img class="mr-3" src="img/neko-resize.png" alt="" width="48" height="48">
                  <div class="lh-100">
                    <h1 class="mb-0 text-white lh-100">Cyber Users</h1>
