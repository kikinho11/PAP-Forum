<?php
    ...
    define('TITLE',"Edit Profile | Cyber Forums");
    ...
    <?php include 'includes/navbar.php'; ?>
      <div class="container">
        ...
        <div class="col-sm-8 text-center" id="user-section">
              ...
              <img class="cover-img" id='blah-cover' src="img/black-bg.jpg">
              ...
              <form action="includes/profileUpdate.inc.php" method='post' enctype="multipart/form-data"
                  ...
                  <br><input type="submit" class="btn btn-dark" name="update-profile" value="Update Profile">
